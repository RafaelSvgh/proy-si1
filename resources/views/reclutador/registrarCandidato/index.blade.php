<x-admin-layout>
    ...
    <div class="py-4 flex items-center justify-between">
        ...
        <a href="{{ route('reclutador.create') }}"
            ...
            <tbody>
                @forelse ($users as $user)
                    <tr
                        ...
                        <td class="px-6 py-4">
                            <a href="{{ route('reclutador.edit', $user->id) }}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline me-3">
